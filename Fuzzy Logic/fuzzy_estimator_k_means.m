function fuzzy_estimator_k_means()
    ...
    outVid = VideoWriter(strcat(motherPath, strcat("output\", strcat(fileName, "_fekm.mp4"))), 'MPEG-4');
    outVid.Quality = 90;
    ...
    close(outVid);
    % Average FPS: 1.803065     Average iteration: 1.249634
    % Average FPS: 2.157835     Average iteration: 1.019308
end